...
public class Sighting
{
    ...
    // The location in which they were seen.
    private final Location loc;
    // The reporting period.
    private final int period;
    
    /**
     * Create a aSighting of a sighting of a particular type of animal.
     ...
     */
    public Sighting(String animal, int spotter, int count, Location loc, int period)
    {
        this.animal = animal;
    ...
    /**
     * Return the location in which they were seen.
